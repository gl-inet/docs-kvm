...
4. Connect Comet 5G to a network source.
    ...
    !!! Note
        The connection priority is **Ethernet** > **Wi-Fi** > **5G**. For the complete logic of WAN Network Detection and Failover, please see [**here**](../../faq/wan_network_detection_and_failover_logic_of_comet5g.md).
