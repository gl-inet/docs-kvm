...
![video](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1pe/console/session_video.png){class="glboxshadow"}
...
![firmware upgrade 2](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1pe/console/toolbar_upgrade_2.png){class="glboxshadow" width=400}

![firmware upgrade 3](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1pe/console/toolbar_upgrade_3.png){class="glboxshadow" width=400}
...
You can check and modify  Comet PoE's network details, such as Hostname and IP address.
...
- **Ethernet Settings**: When Comet PoE connects to an upstream network device via an Ethernet cable, its Ethernet details will be displayed here. 
...
- TLS Certificate
    ...
    ![TLS certificate custom](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1pe/console/setting_security_custom.png){class="glboxshadow"} 
