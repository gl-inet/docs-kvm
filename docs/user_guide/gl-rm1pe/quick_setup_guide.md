...
FFor clarity, Device A refers to the controlling device, and Device B the controlled device.
...
You will be able to access the Comet PoE's console locally, thus access the controlled device connected to it.
