...
![settings](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/settings-general.png){class="glboxshadow"}
...
![settings-video](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/settings-video.png){class="glboxshadow"}
...
![settings-remote device](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/settings-remote-device.png){class="glboxshadow"}
...
![settings-system](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/settings-system.png){class="glboxshadow"}
...
![toolbox](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/toolbox-general.png){class="glboxshadow"}
...
![toolbox-clipboard](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/toolbox-clipboard.png){class="glboxshadow"}
...
![toolbox-wol](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/toolbox-wol.png){class="glboxshadow"}  
...
![accessories fingerbot](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/accessories-fgb.png){class="glboxshadow"}
...
![accessories atxpower](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/accessories-atx.jpg){class="glboxshadow"}
...
![virtual media](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/vm-general.png){class="glboxshadow"}
...
3. On the Comet's console, go to **This PC** of your controlled device. 
...
1. Drag or click the box to upload files. **Ensure this file can be mounted as an iso format**.
    ...
    ![upload files](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/vm-upload-iso.png){class="glboxshadow"}
    
2. Click **Mount To Remote** -> **Image Mounting**. 

    ![image mounting 1](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/vm-image-mounting1.jpg){class="glboxshadow"}

3. In the pop-up window, select the file and click **Mount Image**.

    ![image mounting 2](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/vm-image-mounting2.jpg){class="glboxshadow"}
...
![replace storage drive](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/vm-replace-storage.png){class="glboxshadow"}

### Format Disk

You can format the disk or disable the virtual media with one click.

![format disk](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/vm-format-disk.png){class="glboxshadow"}
...
![apps center](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/apps-tailscale1.png){class="glboxshadow"}
...
![help](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/help.png){class="glboxshadow"}
...
![firmware upgrade](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/upgrade1.png){class="glboxshadow" width="440"}

![firmware upgrade](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/upgrade2.png){class="glboxshadow"}

### Cloud Service

GL.iNet KVM can be accessed locally, so as to manage the controlled device under local network.

If you want to access the controlled device remotely, we suggest you use Cloud service. Click [here](../gl-rm1/quick_setup_guide.md#remote-access-to-comet) for details.

![cloud service](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/cloud2.png){class="glboxshadow"}
...
- Change Admin Password.
    ...
    ![change admin password](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/change-password.jpg){class="glboxshadow" width="434"}

- 2FA: Enable two-factor authentication to protect your account.

    ![2FA](https://static.gl-inet.com/docs/kvm/user_guide/gl-rm1/control_panel/v1.7/2fa.jpg){class="glboxshadow"}