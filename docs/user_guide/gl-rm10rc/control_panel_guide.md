# Comet 5G (GL-RM10RC) Control Panel Guide
...
3. In the Comet 5G's control screen, go to **This PC** of your controlled device. 
...
2. Turn to the Comet 5G's control panel, click **Virtual Media** in the toolbar and click **Stop Sharing**.
