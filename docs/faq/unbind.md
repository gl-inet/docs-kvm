# How to unbind my KVM device?

There are three ways to unbind KVM from the Cloud.

**Method 1**. Unbind in local access
...
**Method 3**. Unbind in the Cloud

1. Launch a web browser on your computer (Chrome or Edge is recommended for better compatibility). Enter `glkvm.com` in the address bar to access the GLKVM Cloud login page. Enter the admin password to log in.
