...
Hier können Sie die Netzwerkdetails des Comet PoE prüfen und ändern, z. B. Hostname und IP-Adresse.
...
- **Ethernet Settings**: Wenn Comet PoE über ein Ethernet-Kabel mit einem Upstream-Netzwerkgerät verbunden ist, werden hier die Ethernet-Details angezeigt.
