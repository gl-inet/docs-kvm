...
3. Klicken Sie im linken Seitenmenue auf **Screen Wall** und dann auf **Setup Screen Wall**.

    ![screen wall](https://static.gl-inet.com/docs/kvm/tutorials/how_to_use_screen_wall/setup_screen_wall.png){class="glboxshadow"}

4. Waehlen Sie die KVM-Geraete aus, die Sie in der Screen Wall anzeigen moechten, und klicken Sie oben rechts auf **Save Screen Wall**.
...
6. Geben Sie nach dem Verbindungsaufbau das Admin-Passwort fuer jedes Ihrer KVM-Geraete ein.

    ![admin login](https://static.gl-inet.com/docs/kvm/tutorials/how_to_use_screen_wall/admin_login.png){class="glboxshadow"}

7. Anschliessend koennen Sie die Bildschirme mehrerer Geraete auf einer einzigen Seite anzeigen.
